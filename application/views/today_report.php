										...
										<form name="form" action="<?php echo base_url('report/today_report') ?>" method="POST">
											...
											<fieldset>
                                               <div class="control-group span2" style="margin-left:0px;">
                                                <label for="id-date-range-picker-1"  style="margin-bottom:0px;">Date</label>
												<div class="row-fluid input-prepend">
												<input class="span11 date-picker" id="id-date-picker-1" name="date" type="text" data-date-format="yyyy-mm-dd" />
												<span class="add-on">
                            ...
                            <div class="row-fluid">
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									<thead>
										...
										<th width="5%" class="center">Print</th>
									...
									<tbody id="show_record">
										...
										<tr>
											...
											<td class="center"><?php 
											 ...
											 <td class="center"><i class="icon-print" data-id="<?php echo $row->id ?>" id="prints" style="cursor: pointer;color: green"></td>
											 <td class="center"><i class="icon-trash" data-id="<?php echo $row->id ?>" id="delete" style="cursor: pointer;color: red"></td>
										</tr>
									<?php }}
									else
									{?>
