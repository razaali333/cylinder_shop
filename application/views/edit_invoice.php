    ...
    <div class="box">
        <div class="box-header with-border">
          ...
          <!-- form start here -->
            ...
            <form action="<?php echo base_url('product/update_invoice/'.$id.'') ?>" method="post">
            <div class="row">
            ...
            <select name="agency" id="" class="form-control">
              <option value="" disabled="" selected="">Select Agency</option>
               <?php foreach($agency->result() as $row){ ?>
                    ...
                    <option value="<?php echo $row->id ?>" <?php if($inv_id==$row->id) { ?> selected="selected" <?php } ?> ><?php echo $row->agency_name; ?></option>
                  <?php } ?>
            </select>
        ...
        <table class="table table-striped">
          ...
          <tbody id="inv_detail">
              ...
              <td class="text-center"><input type="text" readonly="" name="subtotal[]" value="<?php echo $row->item_subtotal ?>" class="form-control amt"></td>
          ...
          <div class="table-responsive">
            ...
            <table class="table">
              <tr>
                ...
                <td><input type="text" readonly="" name="total" value="<?php echo $row->inv_subtotal ?>" class="form-control input-sm total"></td>
              </tr>
