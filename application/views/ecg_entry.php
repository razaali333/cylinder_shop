										...
										<fieldset>
                                                    ...
                                                    <div class="span3">
                                                        ...
                                                        <label><strong> Departement</strong> &nbsp;&nbsp; </label>
                                                        	<select  id="departement" name="shift" data-placeholder="Select Gander" >					
                                                        	<option value="morning" id="ECG">ECG</option>
							 							
														</select>
														</div>

														<div class="span2"> 
                                                        <label><strong>Sub Departement</strong> &nbsp;&nbsp; </label>
                                                        	<select  id="sub_departement" name="shift" data-placeholder="Select Gander" >	
                                                        	<?php foreach($query->result() as $row ){?>				
                                                        	<option value="<?php echo $row->id ?>" id=""><?php echo $row->name; ?></option>
							 								<?php } ?>
														</select>
														</div>
                                                       </fieldset>
...
$(function() {
	...
	$('#save').on('click',function(e){
		...
		$.ajax({
			...
			method:'POST',
			data:{receptNumber:receptNumber,name:name,address:address,age:age,shift:shift,gander:gander,departement:departement,sub_departement:sub_departement},
			success:function()
			{
