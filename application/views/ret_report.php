 ...
 <?php include('include/sidebar.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> All Return Payment Reports.
      ...
      <!-- info row -->
      <form action="<?php echo base_url('reports/return_report'); ?>" method="post">
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr id="show_tr">
              ...
              <td id="amt"><?php echo $row->amount ?></td>
            </tr>
           <?php } } else{?>
            <tr>
              <td colspan="6" class="text-center" style="font-weight: bold;color: red;">No Amount Return On this Day</td>
            </tr>
            <?php } ?>
            </tbody>
